...
// list
const category = await useFetch("/api/devtool/care-service/category/list");
...
const clickAdd = async () => {
  try {
    const { data: add } = await useFetch(
      "/api/devtool/care-service/category/create",
      {
        method: "POST",
        body: JSON.stringify({
...
const editButton = async (id) => {
  try {
    const { data: detail } = await useFetch(
      "/api/devtool/care-service/category/get",
      {
        method: "GET",
        query: {
          id: parseInt(id),
...
const clickUpdate = async () => {
  try {
    const { data: update } = await useFetch(
      "/api/devtool/care-service/category/update",
      {
        method: "POST",
        body: JSON.stringify({
          id: editInput.value,
...
const clickDelete = async () => {
  try {
    const { data: deleted } = await useFetch(
      "/api/devtool/care-service/category/delete",
      {
        method: "POST",
        body: JSON.stringify({
