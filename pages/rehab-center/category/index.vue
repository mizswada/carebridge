<script setup>
    ...
    // list
    const category = await useFetch('/api/rehab-center/category/list');
    ...
    {       
        try {
            const { data: detail } = await useFetch("/api/rehab-center/category/get", {
                method: "GET",
                query: {
                    id: parseInt(id),
                },
    ...
    {
      try {
        const { data:deleted} = await useFetch("/api/rehab-center/category/delete", {
            method: "POST",
            body: JSON.stringify({                  
