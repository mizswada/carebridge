<script setup>
    ...
    const clickAdd = async () => 
    {
        ...
        try {
          ...
          const { data:uploadImage } = await useFetch("/api/rehab-center/equipment/upload", {
            method: 'POST',
            body: {
          ...
          {          
            const { data: add } = await useFetch("/api/rehab-center/equipment/create", {
                method: "POST",
                body: JSON.stringify({  
                    user_id : id,
    ...
    {       
      selectedEquipment.value=id;
        try {
            const { data: detail } = await useFetch("/api/rehab-center/equipment/get", {
                method: "GET",
                query: {
                    id: parseInt(id),
                },
    ...
    const clickUpdate = async () => 
    {
        ...
        try {
            const { data: update } = await useFetch("/api/rehab-center/equipment/update", {
                method: "POST",
                body: JSON.stringify({  
    ...
    {
      try {
        const { data:deleted} = await useFetch("/api/rehab-center/equipment/delete", {
            method: "POST",
            body: JSON.stringify({                  
