<script setup>
    ...
    // list
    const rehab = await useFetch('/api/association/pending/list');
    ...
    <div class="space-y-8">
      ...
      <div class="pb-20">
        <div class="bg-white p-6 rounded-lg shadow-md">
          <div class="text-lg font-medium mb-4">List of Pending Approval</div>
          <div class="flex justify-end items-center mb-3 gap-5"></div>
          <div v-if="rehabList.length == 0">
            No data
          </div>
            <rs-table v-else
                  :data="rehabList"
                ...
                <template #action ="rehabList" >
                  <div class="flex items-center gap-4">
                    <nuxt-link :to="`/association/pending/view/`+rehabList.value.id">
                      <rs-button >
                        <Icon
