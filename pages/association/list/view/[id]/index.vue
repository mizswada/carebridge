<script setup>
  ...
  if (detail.value.response === 200)
  {
    ...
    formData.value.establishment_date = detail.value.data.details.establishment_date;
...
<template>
  ...
  <div class="bg-white p-8 rounded-lg shadow-md">
    ...
    <form @submit.prevent="submitForm">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <FormKit type="file" v-model="formData.document_logo" @change="onChangeFile3" :disabled="!isEditing" required >
          <template #label>
