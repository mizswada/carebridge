<script setup>
    ...
    // list
    const contact = await useFetch("/api/caretaker/contact/list", {
        method: "GET",
        query: {
            id: parseInt(id),
        },
    ...
    const clickAdd = async () => 
    {
        ...
        try {
          ...
          const { data: add } = await useFetch("/api/caretaker/contact/create", {
              method: "POST",
              body: JSON.stringify({  
                  user_id : id,
    ...
    {       
      selectedContact.value=id;
        try {
            const { data: detail } = await useFetch("/api/caretaker/contact/get", {
                method: "GET",
                query: {
                    id: parseInt(id),
                },
    ...
    const clickUpdate = async () => 
    {
        try {
          ...
          const { data: update } = await useFetch("/api/caretaker/contact/update", {
              method: "POST",
              body: JSON.stringify({  
    ...
    {
      try {
        const { data:deleted} = await useFetch("/api/caretaker/contact/delete", {
            method: "POST",
            body: JSON.stringify({                  
              id: selectedContact.value,
            }),
