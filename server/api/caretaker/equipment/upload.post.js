...
export default defineEventHandler(async (event) => {
  try {
    ...
    const dir = path.join(process.cwd(), 'public/uploads/caretaker/equipment');
    ...
    const fileUpload = path.join(process.cwd(), `public/uploads/caretaker/equipment/${fileName}`);
    //const fileUpload = `/home/ascii/ALSB/public/img/uploads/${body.operationID}/${fileName}`;
    const filePath = `/uploads/caretaker/equipment/${fileName}`;
