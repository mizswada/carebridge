...
export default defineEventHandler(async (event) => {
  try {
    ...
    const dir = path.join(process.cwd(), 'public/uploads/association/activity');
    ...
    const fileUpload = path.join(process.cwd(), `public/uploads/association/activity/${fileName}`);
    //const fileUpload = `/home/ascii/ALSB/public/img/uploads/${body.operationID}/${fileName}`;
    const filePath = `/uploads/association/activity/${fileName}`;
