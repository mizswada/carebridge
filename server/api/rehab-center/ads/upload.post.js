...
export default defineEventHandler(async (event) => {
  try {
    ...
    const dir = path.join(process.cwd(), 'public/uploads/rehab/advertising');
    ...
    const fileUpload = path.join(process.cwd(), `public/uploads/rehab/advertising/${fileName}`);
    //const fileUpload = `/home/ascii/ALSB/public/img/uploads/${body.operationID}/${fileName}`;
    const filePath = `/uploads/rehab/advertising/${fileName}`;
