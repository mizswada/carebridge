...
export default defineEventHandler(async (event) => {
  try {
    ...
    const dir = path.join(process.cwd(), 'public/uploads/rehab/equipment');
    ...
    const fileUpload = path.join(process.cwd(), `public/uploads/rehab/equipment/${fileName}`);
    //const fileUpload = `/home/ascii/ALSB/public/img/uploads/${body.operationID}/${fileName}`;
    const filePath = `/uploads/rehab/equipment/${fileName}`;
